...
public class ParkingEngineException extends Exception {
	...
	public static final int APP_ID_INVALID_OR_NULL 			= 30;
	public static final int SESSIONKEY_INVALID_OR_NULL 		= 31;
	public static final int USERID_INVALID_OR_NOTMATCH 		= 32;
	public static final int ISSUENUMBER_NOT_FOUND 			= 33;
	public static final int USER_ACCESS_FAIL 				= 34;
	public static final int CHANGESTATUS_SMALLERTHANEXIST	= 35;
	public static final int CHANGESTATUS_PROCESSDONE		= 36;
	public static final int CHANGESTATUS_SAMEASEXIST		= 37;
	public static final int DATA_NOT_FOUND					= 38;
