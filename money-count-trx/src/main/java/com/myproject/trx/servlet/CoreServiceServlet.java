package com.myproject.trx.servlet;
...
public class CoreServiceServlet extends HttpServlet {
	...
	private static final Logger LOG = LoggerFactory.getLogger(CoreServiceServlet.class);
...
//		response.sendError(HttpServletResponse.SC_METHOD_NOT_ALLOWED);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		/*if(!"/charge".equalsIgnoreCase(pathInfo)&&!"/payment_notif".equalsIgnoreCase(pathInfo)){
			data = CipherUtil.decryptDESede(data, CipherUtil.KEY);
		}*/
